...
<tr>
	<div class="row">
		<label for="apelNom"><b>NOMBRE</b></label><br />
		<input id="txtApelNom" class="input" name="name" type="text" value="" size="57" /><br /> 
	</div>
</tr>
<tr>
	<div class="row">
		<label for="email"><b>EMAIL</b></label><br />
		<input id="txtEmail" class="input" name="email" type="text" value="" size="57" /><br />
	</div>
    </tr>
    <tr>
    <div class="row">
		<label for="email"><b>TELEFONO</b></label><br />
		<input id="txtTelefono" class="input" name="email" type="text" value="" size="57" /><br />
	</div>
    </tr>
    <tr>
	<div class="row">
		<label for="mensaje"><b>MENSAJE</b></label><br />
		<textarea id="txtMensaje" class="input" name="message" rows="12" cols="48"></textarea><br /><br />
	</div>
    </tr>
    </table>
 <form id="form6"> 
